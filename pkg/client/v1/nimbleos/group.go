...
type Group struct {
 ...
 // CloudEnabled - Specifies whether cloud management is enabled.
    CloudEnabled *bool `json:"cloud_enabled,omitempty"`
 // IsCloudConnected - Whether array is connected to cloud services.
    IsCloudConnected *bool `json:"is_cloud_connected,omitempty"`
