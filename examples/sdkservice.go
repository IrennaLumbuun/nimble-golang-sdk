...
func getFakeService(ip, username, password, apiVersion string, synchronous, tenantAware bool) (sdkprovider.NsGroupService, error) {

	grpSvc, err := fakeservice.NewNsGroupService(ip, username, password, apiVersion, synchronous, tenantAware)
	return grpSvc, err
}
...
func main() {
	...
	// Get real service
	groupService, _ = getRealService("10.157.82.90", "raunak", "Nim123Boli", "v1", false, true)
